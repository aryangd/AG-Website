...
export default function Blog() {
    const posts = [
      { 
        title: "How Casual RPG mobile games are more Fun to Play", 
        date: "-", 
        img: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=800&auto=format&fit=crop&q=60",
        link: ""
      },
      { 
        title: "Mobile games Gacha System Evolution", 
        date: "-", 
        img: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=800&auto=format&fit=crop&q=60",
        link: ""
      },
      { 
        title: "Player Hook Loop", 
        date: "-", 
        img: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&auto=format&fit=crop&q=60",
        link: "https://gameanalytics.com/blog/how-to-design-a-perfect-core-loop/"
      },
    ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post, i) => (
            <motion.div
              ...
              className={`group cursor-pointer flex flex-col gap-6 p-5 rounded-xl border border-transparent hover:shadow-[0_0_35px_rgba(12,219,160,0.4)] transition-all duration-75 ${!post.link ? 'cursor-default' : ''}`}
            >
              <div className="relative overflow-hidden aspect-[4/3] rounded-lg">
                <div className="absolute inset-0 bg-black/20 group-hover:bg-transparent transition-colors z-10" />

                {/* Coming Soon Tag - only show if there is NO link */}
                {!post.link && (
